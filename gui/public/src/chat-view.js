...
function renderAutofillBody(card) {
  ...
  const lead = blocked
    ? "The form is filled. LinkedIn, Indeed, and Dice do not allow Desk to press Submit. Check the fields and click their Submit button yourself, then press Done."
    : "The form is filled and nothing is sent yet. Submit for me presses the employer's Submit button. Or send it yourself, then press Done.";
  const submit = blocked
    ? ""
    : `<button type="button" data-decision="submit"${disabled}>Submit for me</button>`;
